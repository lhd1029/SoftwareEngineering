...
#include "../../HotelAirCondiManSystem/clientcontroller.h"
...
QT_MOC_LITERAL(1, 17, 17), // "SignalWindUpdated"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "ClientController\0SignalWindUpdated\0"
};
...
void ClientController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalWindUpdated(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ClientController::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientController::SignalWindUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientController::SignalWindUpdated()
{
